  ...
  contactIcons.innerHTML = `
    <div class="contact-container">
      ...
      <div class="contact-methods">
        ...
        <div class="contact-method">
          <div class="contact-icon-wrapper">
            <a class="contact-icon" href="https://www.instagram.com/sahil_vrmjji/" target="_blank" title="Instagram">
          ...
          <div class="contact-info">
            <h4>Instagram</h4>
            <a href="https://www.instagram.com/sahil_vrmjji/" target="_blank">@sahil_vrmjji</a>
          </div>
        </div>
